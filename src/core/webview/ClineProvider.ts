...
export class ClineProvider extends EventEmitter<ClineProviderEvents> implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "paypal-roo-cline.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "paypal-roo-cline.TabPanelProvider"
	...
	*/
	...
	public static async getInstance(): Promise<ClineProvider | undefined> {
		...
		if (!visibleProvider) {
			await vscode.commands.executeCommand("paypal-roo-cline.SidebarProvider.focus")
				...
				switch (message.type) {
					...
					case "allowedCommands":
						...
						await vscode.workspace
							.getConfiguration("paypal-roo-cline")
					...
					case "humanRelayResponse":
						if (message.requestId && message.text) {
							vscode.commands.executeCommand("paypal-roo-cline.handleHumanRelayResponse", {
	...
	async getStateToPostToWebview() {
		...
		const allowedCommands =
			vscode.workspace.getConfiguration("paypal-roo-cline").get<string[]>("allowedCommands") || []
